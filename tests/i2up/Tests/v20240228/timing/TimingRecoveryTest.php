...
use i2up\timing\v20240228\TimingRecovery;
...
class TimingRecoveryTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testUnmountTimingRecovery()
    {
        $timingRecovery = $this -> timingRecovery;
        $arr = array(
            'task_uuids'=>array('11111111-1111-1111-1111-111111111111'),
        ...
        $res = $timingRecovery -> unmountTimingRecovery($arr);
        $this->do_assert($res);
    }
    public function testMountLogonTimingRecovery()
    {
        $timingRecovery = $this -> timingRecovery;
        $arr = array(
            'task_uuids'=>array('11111111-1111-1111-1111-111111111111'),
        ...
        $res = $timingRecovery -> mountLogonTimingRecovery($arr);
        $this->do_assert($res);
    }
    public function testUnmountLogoutTimingRecovery()
    {
        $timingRecovery = $this -> timingRecovery;
        $arr = array(
            'task_uuids'=>array('11111111-1111-1111-1111-111111111111'),
        ...
        $res = $timingRecovery -> unmountLogoutTimingRecovery($arr);
        $this->do_assert($res);
    }
    ...
    public function testListTimingRecoveryDb()
    {
        $timingRecovery = $this -> timingRecovery;
        $arr = array(
            'bk_uuid'=>'B8566905-411E-B2CD-A742-77B1346D8E84',
...
',
        ...
        $res = $timingRecovery -> listTimingRecoveryDb($arr);
        $this->do_assert($res);
    }
    ...
    public function testOperateVolume()
    {
        $timingRecovery = $this -> timingRecovery;
        $arr = array(
            'volume_uuid'=>'',
        ...
        $res = $timingRecovery -> operateVolume($arr);
        $this->do_assert($res);
    }
