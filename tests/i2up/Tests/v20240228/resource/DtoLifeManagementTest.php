...
use i2up\resource\v20240228\DtoLifeManagement;
...
class DtoLifeManagementTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testDeleteDtoLm()
    {
        $dtoLifeManagement = $this -> dtoLifeManagement;
        $arr = array(
            'type'=>'delete',
        ...
        $res = $dtoLifeManagement -> deleteDtoLm($arr);
        $this->do_assert($res);
    }

    public function testStartDtoLm()
    {
        $dtoLifeManagement = $this -> dtoLifeManagement;
        $arr = array(
            'type'=>'start',
        ...
        $res = $dtoLifeManagement -> startDtoLm($arr);
        $this->do_assert($res);
    }

    public function testStopDtoLm()
    {
        $dtoLifeManagement = $this -> dtoLifeManagement;
        $arr = array(
            'type'=>'stop',
        ...
        $res = $dtoLifeManagement -> stopDtoLm($arr);
        $this->do_assert($res);
    }
