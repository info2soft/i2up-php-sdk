...
use i2up\resource\v20240228\Storage;
...
class StorageTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListStorageStatus()
    {
        ...
        $arr = array(
            'uuids'=>array(
                ...
                '1'=>'4735BBB0-25BE-1Afc-f12c-Af6a8cFCbfC9',
            ),
            'force_refresh'=>1,
        );
    ...
    public function testModifyStorageQuota()
    {
        ...
        $arr = array(
            'uuid' => '11111111-1111-1111-1111-111111111111',
            'quota_uuid' => '11111111-1111-1111-1111-111111111111',
            'zpool_name'=>'2.85',
            'zfs_name'=>'xxx',
            'zfs_mount_path'=>'',
            'zfs_quota'=>1,
    ...
    public function testUpdateTapePools()
    {
        $storage = $this -> storage;
        $arr = array(
            'tape_uuids' => array(),
            'operate' => 'update_pools',
            'slot' => array(
                '0' => array(
                    'slot _index' => '',
                    'slot_barcode' => '',
        ...
        $res = $storage -> updateTapePools($arr);
        $this->do_assert($res);
    }
    ...
    public function testListBkFile()
    {
        $storage = $this -> storage;
        $arr = array(
            'tape_uuid'=>'CC3456f6-0aF9-e5dE-c9e3-AE39EF15dCDf',
            'library_sn'=>'F8eFA42E-7e8d-5FCE-F7Fd-FDDAc8Dd7Ede',
            'slot _index'=>'1',
            'slot_barcode'=>'4289587102703324	',
            'slot_tapename'=>'然好压更直	',
            'slot_tapesequence'=>'1509046332937302	',
            'bk_index'=>'index',
            'bk_path'=>'path',
            'page'=>1,
            'limit'=>10,
    ...
    public function testListTapePools()
    {
        $storage = $this -> storage;
        $arr = array(
            'where_args[tape_uuid]'=>'',
            'where_args[library_sn]'=>'',
            'limit'=>1,
            'page'=>1,
        );
