...
use i2up\common\v20240228\GeneralInterface;
...
class GeneralInterfaceTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testExportRules()
    {
        ...
        $arr = array(
            ...
            'type' => '',
            'sub_type' => '',
            'where_args' => '[{"bk_path":[],"rc_time_point_list":[],"bk_data_type":1,"wk_data_type":1,"backup_type":1,"task_uuid":"","blk_direct_copy":"","mount_point":""}]',
            'uuids' => array(),
            'for_import' => 0,
            'filter_uuid' => '',
        );
