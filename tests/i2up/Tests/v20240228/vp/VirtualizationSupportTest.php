<?php
namespace i2up\Test\v20240228\vp;

use i2up\vp\v20240228\VirtualizationSupport;
...
class VirtualizationSupportTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testStartImmediatelyVpBackup()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
        ...
        $res = $virtualizationSupport -> startImmediatelyVpBackup($arr);
        $this->do_assert($res);
    }

    public function testAutoDiscoveryVpBackup()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
        ...
        $res = $virtualizationSupport -> autoDiscoveryVpBackup($arr);
        $this->do_assert($res);
    }
    ...
    public function testModifyVpMoveGroup()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
            'uuid' => '11111111-1111-1111-1111-111111111111',
        ...
        $res = $virtualizationSupport -> modifyVpMoveGroup($arr);
        $this->do_assert($res);
    }
    ...
    public function testModifyVpMove()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'642bE473-2FEA-Fc39-3bC7-aBa9EeEC84dD',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
    ...
    public function testCreateTargetVmVpMove()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
        ...
        $res = $virtualizationSupport -> createTargetVmVpMove($arr);
        $this->do_assert($res);
    }
