...
use i2up\cloud\v20240228\CloudEcs;
...
class CloudEcsTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testGetTakeover()
    {
        $cloudEcs = $this -> cloudEcs;
        $arr = array(
            'ecs_id'=>'',
        );
        $res = $cloudEcs -> getTakeover($arr);
        $this->do_assert($res);
    }
    ...
    public function testListIdleDevice()
    {
        ...
        $res = $cloudEcs -> listIdleDevice($arr);
        $this->do_assert($res);
    }
