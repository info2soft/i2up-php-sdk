<?php
namespace i2up\Test\v20240228\distributor;

use i2up\distributor\v20240228\DistributorNode;
use i2up\common\Auth;
                
class DistributorNodeTest extends \PHPUnit_Framework_TestCase
 {
    private $distributorNode;
    
    public function __construct($name = null, array $data = array(), $dataName = '')
    {
        parent::__construct($name, $data, $dataName);
        $this -> distributorNode = new DistributorNode(new Auth());
    }

    public function testReadme()
    {
        $distributorNode = $this -> distributorNode;
        $arr = array(
        ...
        $res = $distributorNode -> readme($arr);
        $this->do_assert($res);
    }
    ...
    public function testRegister()
    {
        ...
        $res = $distributorNode -> register($arr);
        $this->do_assert($res);
    }
    ...
    public function testUpdateStatus()
    {
        ...
        $res = $distributorNode -> updateStatus($arr);
        $this->do_assert($res);
    }
    ...
    public function testListNode()
    {
        ...
        $res = $distributorNode -> listNode($arr);
        $this->do_assert($res);
    }
    ...
    public function testListNodeStatus()
    {
        ...
        $arr = array(
            'node_uuids'=>array(
            '0'=>'5D5B2fC6-9dEB-Cef2-3abB-588CEFAd8F81',),
            'node_type'=>1,
        );
        $res = $distributorNode -> listNodeStatus($arr);
        $this->do_assert($res);
    }
    ...
    public function testDescribeNode()
    {
        ...
        $res = $distributorNode -> describeNode($arr);
        $this->do_assert($res);
    }
    ...
    public function testFileConfig()
    {
        ...
        $res = $distributorNode -> fileConfig($arr);
        $this->do_assert($res);
    }
    ...
    public function testWarnConfig()
    {
        ...
        $res = $distributorNode -> warnConfig($arr);
        $this->do_assert($res);
    }
    ...
    public function testUpgrade()
    {
        ...
        $res = $distributorNode -> upgrade($arr);
        $this->do_assert($res);
    }
    ...
    public function testDelete()
    {
        ...
        $res = $distributorNode -> delete($arr);
        $this->do_assert($res);
    }
    ...
    public function testTopography()
    {
        ...
        $res = $distributorNode -> topography($arr);
        $this->do_assert($res);
    }
    ...
    public function testLatency()
    {
        ...
        $res = $distributorNode -> latency($arr);
        $this->do_assert($res);
    }
