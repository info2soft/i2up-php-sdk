<?php
namespace i2up\Test\v20250630\dto;

use i2up\dto\v20250630\Dto;
...
class DtoTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListDtoRule()
    {
        ...
        $arr = array(
            ...
            'status'=>'LIST_STOP',
            'where_args'=>array(
            'rule_uuid'=>'eb6Bd468-41cf-BdED-Cec6-C2BB7D0E4aEb',
            'status'=>'STOP',),
        );
    ...
    public function testListDtoRuleSourcePath()
    {
        $dto = $this -> dto;
        $arr = array(
            'host_uuid'=>'BEcA4B04-86D8-EBf4-fA4A-d7dbEe1D2BAE',
            'timepoint'=>'@timestamp()',
            'host_ip'=>'',
            'prefix'=>'',
            'mapper_path'=>'',
