<?php
namespace i2up\Test\v20250630\bigdata;

use i2up\bigdata\v20250630\Backup;
...
class BackupTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListBigdataHiveTable()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'5AC93Af2-B2ca-fe7d-fA5d-7E87AA91ebaa',
            'table_name'=>'',
            'limit'=>'',
            'page'=>'',
            'db_name'=>'',
    ...
    public function testListAllBigdataHiveDatabase()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'73F53f7A-b065-2f82-8bf4-d10f9e1Dcf23',
            'cluster_config_path'=>'',
            'platform_uuid'=>'',
        );
