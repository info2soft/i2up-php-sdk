...
use i2up\active\v20250630\Hetero;
...
class HeteroTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'target_user'=>'oracle',
            'target_db_name'=>'Shirley Perez',
            'db_name'=>'Christopher Hall',
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'dDCAA1eF-1bE6-410d-f4C9-F4DbcA310DDD',
            '1'=>'fee2CBDe-EAed-58f0-933b-82bEb5f882bA',),
            'force'=>true,
        );
    ...
    public function testStopConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'FF78eAEb-cbea-2c4e-fFB5-fDc5A8CEBB41',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'73686eD6-F0b7-bddD-DBED-363c0e2519BA',
            'operate'=>'resume',
        );
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'search_value'=>'',
            'where_args'=>array(
            'uuid'=>'dDeEd4c4-389D-6ccc-f6d0-58A86d3b6AC1',
            'status'=>'',
            'src_db_name'=>'test',
            'tgt_db_name'=>'',
            'db_ip'=>'',
    ...
    public function testDeleteHeteroGraph()
    {
        ...
        $arr = array(
            'graph_uuids'=>array(
            '0'=>array(
            'graph_uuid'=>'2BF99931-CFcb-CF90-Bfc5-DCEEbc2ec73C',
            'rule_uuids'=>array(
            '0'=>array(
            'uuid'=>'334EF1f9-AB3E-AFCF-04Fb-7ee6Ef39e387',
            'is_rule'=>'1',
            'rule_number'=>'4',
            'src_type'=>'oracle',),),),),
            'is_whole'=>'1',
