...
use i2up\active\v20250630\Tidb;
...
class TidbTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testResumeTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'0FcD27CF-314f-6be6-cdF6-7Be3d4FeD77c',
            'scn'=>'',
        );
    ...
    public function testStopTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'FFb2ED1B-E4c4-eB79-7dd4-6697E5c7BF36',
            'scn'=>'',
        );
    ...
    public function testRestartTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'a1BEBB48-cfb4-0c67-4897-A8fDe5f69644',
            'scn'=>'',
        );
    ...
    public function testStartParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'f7eDA8d9-5E87-cE49-9424-b374fb1e0D6b',
            'scn'=>'',
        );
    ...
    public function testStopParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'4091A44D-eEb1-88de-23BC-ADb951e6Afdc',
            'scn'=>'',
        );
    ...
    public function testResetParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'e0408dd6-D90C-bfe6-661b-ef1EA8DA2f5b',
            'scn'=>'',
        );
    ...
    public function testStartLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'07A6779E-ef7e-f3e4-bbBD-C6E57757F4Ce',
            'scn'=>'',
        );
    ...
    public function testStopLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'3053984c-94Bd-7E97-bF2C-7C66FE2D6dE1',
            'scn'=>'',
        );
    ...
    public function testResetLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'A421d1D6-5931-EE21-6BcB-3e540D87eeb8',
            'scn'=>'',
        );
    ...
    public function testRemoveTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'61EEdECA-39ed-ed85-9549-5cb4245EC27F',
            'scn'=>'',
        );
    ...
    public function testListTidbRules()
    {
        ...
        $arr = array(
            'where_args'=>array(
            'mysql_uuid'=>'2AFCD7CE-e25e-De64-93e7-E8BCF276Dffd',),
            'page'=>1,
            'limit'=>10,
            'search_field'=>'',
            'search_value'=>'',
