...
use i2up\active\v20250630\HeteroConsumer;
...
class HeteroConsumerTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'0FA7254b-4Dce-A75C-8bEB-21478b75B5af',),
        );
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'machine_num'=>1,
            'target_user'=>'oracle',
            'target_db_name'=>'Sandra Harris',
            'error_deal'=>'',
            'db_name'=>'Frank Harris',
    ...
    public function testModifyConsumerRule()
    {
        ...
        $arr = array(
            ...
            'use_source_table_key'=>false,),
            'target_user'=>'oracle',
            'target_db_name'=>'Brenda Martinez',
            'db_name'=>'Brenda Lee',
            'kerberos_certify'=>false,
            'dmltrack'=>array(
            'enable'=>false,
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'fBAc5111-cfc6-2d7F-cA30-e63bFe7A8bB5',
            '1'=>'bbCcFf99-C111-BFaD-C93D-3ff1F4B227d2',),
        );
    ...
    public function testStopConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'fc05E277-00C5-c1F4-5eD4-4edeFEE3fAf1',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'40Dc6f6D-77De-7BA1-Ef8a-867e8b2D27EB',
            'operate'=>'resume',
        );
