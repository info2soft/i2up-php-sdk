...
use i2up\stream\v20250630\TbCmp;
...
class TbCmpTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testStopTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'FA35Ec0C-bDCd-B4eB-cCbe-c95355E3F0D1',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testRestartTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'b53f67Eb-2Bd7-1FE8-eCEf-fbbe7AE2fD68',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpStopTime()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'e9c0f568-F103-8614-AfD4-Ae34Bad94fF6',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpResumeTime()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'CCF38afA-fCBC-3B84-9f4B-Bd153dEb8067',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpImmediate()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'f32Aa8fb-5ffc-9De9-c066-A1FE85eAeD72',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testDescribeSyncTbCmpResult()
    {
        ...
        $arr = array(
            'page'=>1,
            'limit'=>10,
            'uuid'=>'EC762Ba5-F8F9-340D-E3F7-c18Fcbb56d8C',
            'start_time'=>'',
            'flag'=>1,
            'user'=>'',
            'table'=>'',
    ...
    public function testDescribeTbCmpErrorMsg()
    {
        ...
        $arr = array(
            'offset'=>1,
            'limit'=>10,
            'uuid'=>'5ecCD104-3ECE-eF0f-1F80-e8aDcbCACFEf',
            'start_time'=>'',
            'key_name'=>'',
            'column_name'=>'',
            'src_db'=>'',
