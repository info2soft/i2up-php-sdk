<?php
namespace i2up\Test\v20250630\vp;

use i2up\vp\v20250630\VirtualizationSupport;
...
class VirtualizationSupportTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testModifyVpMove()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'2C7EB48b-E24A-183c-7b9F-2eb37e1fcb2B',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
    ...
    public function testModifyVpRep()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'FAC76c7C-2dA7-5D19-3B7E-DE81fe67c1df',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
