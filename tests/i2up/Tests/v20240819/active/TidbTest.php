...
use i2up\active\v20240819\Tidb;
...
class TidbTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testResumeTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'63Bfe14b-C96C-e0B2-e684-A688dfD5cB91',
            'scn'=>'',
        );
    ...
    public function testStopTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'1532BeAD-ccd9-55EB-B7D8-b8Dd8aDdeAe2',
            'scn'=>'',
        );
    ...
    public function testRestartTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'8fcD82C7-6ACD-dc5D-f9aB-FC556eBc3a4B',
            'scn'=>'',
        );
    ...
    public function testStartParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'A399F7f6-4C6A-258b-B358-cb9dFcDDBB72',
            'scn'=>'',
        );
    ...
    public function testStopParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'3Af5Adae-6bBF-C4eE-04af-EF98D7c8fEd6',
            'scn'=>'',
        );
    ...
    public function testResetParsingTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'cA9Bbef3-2cee-e001-976d-F6327a56a68a',
            'scn'=>'',
        );
    ...
    public function testStartLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'5Bb867fA-9C68-BC4b-7CC5-353fE96c5AB6',
            'scn'=>'',
        );
    ...
    public function testStopLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'7FbEfFca-6DAD-3397-6bEb-EF92dE386BD7',
            'scn'=>'',
        );
    ...
    public function testResetLoadTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'C2f4Cb6B-2984-D938-8DC3-41c2eFD34282',
            'scn'=>'',
        );
    ...
    public function testRemoveTidbRule()
    {
        ...
        $arr = array(
            'operate'=>'restart',
            'mysql_uuid'=>'De79b2bf-Be75-9d88-bBBA-8b93cF8FDfcb',
            'scn'=>'',
        );
    ...
    public function testListTidbRules()
    {
        ...
        $arr = array(
            'where_args'=>array(
            'mysql_uuid'=>'9a3b02d4-85dA-b4A3-2e7F-CD26a26BAd89',),
            'page'=>1,
            'limit'=>10,
            'search_field'=>'',
            'search_value'=>'',
