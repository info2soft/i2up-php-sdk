...
use i2up\active\v20240819\Hetero;
...
class HeteroTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'target_user'=>'oracle',
            'target_db_name'=>'Richard Lee',
            'db_name'=>'Thomas Johnson',
    ...
    public function testModifyConsumerRule()
    {
        ...
        $arr = array(
            ...
            'use_source_table_key'=>false,),
            'target_user'=>'oracle',
            'target_db_name'=>'James Martin',
            'db_name'=>'Margaret Lee',
            'kerberos_certify'=>false,
            'dmltrack'=>array(
            'enable'=>false,
            'tmcol'=>'',),
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'C369AFe0-de81-CC68-EbB0-5EFbDCfeed5B',
            '1'=>'31b0d2EA-8C3E-DfEc-a4C1-ee9e7DAb5Fd9',),
            'force'=>true,
        );
    ...
    public function testStopConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'592b1F3f-8Fee-Ae7e-dC4B-DBCCF8A97D0E',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'8FDD5EC3-4491-b7AF-D9d2-7B142ad5AF35',
            'operate'=>'resume',
        );
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'search_value'=>'',
            'where_args'=>array(
            'uuid'=>'8Ed5baAa-Cb9F-3121-D7f8-DAf3aA1Ffc93',
            'status'=>'',
            'src_db_name'=>'test',
            'tgt_db_name'=>'',
            'db_ip'=>'',
    ...
    public function testDeleteHeteroGraph()
    {
        ...
        $arr = array(
            'graph_uuids'=>array(
            '0'=>array(
            'graph_uuid'=>'94F81F85-edef-6fd0-d2DE-cD6f3bf63ADC',
            'rule_uuids'=>array(
            '0'=>array(
            'uuid'=>'7eE6FDef-Bc05-22Ed-6D79-bd2A2Db93354',
            'is_rule'=>'1',
            'rule_number'=>'4',
            'src_type'=>'oracle',),),),),
            'is_whole'=>'1',
