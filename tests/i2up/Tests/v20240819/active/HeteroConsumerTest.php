...
use i2up\active\v20240819\HeteroConsumer;
...
class HeteroConsumerTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'machine_num'=>1,
            'target_user'=>'oracle',
            'target_db_name'=>'Karen Lewis',
            'error_deal'=>'',
            'db_name'=>'Sharon Anderson',
    ...
    public function testModifyConsumerRule()
    {
        ...
        $arr = array(
            ...
            'use_source_table_key'=>false,),
            'target_user'=>'oracle',
            'target_db_name'=>'Elizabeth Gonzalez',
            'db_name'=>'Paul Clark',
            'kerberos_certify'=>false,
            'dmltrack'=>array(
            'enable'=>false,
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'263afE8D-88Fe-84bb-E9e9-531ceA98F8B7',
            '1'=>'7B3aE888-aff0-F14E-2574-49CAF9F73Ba4',),
        );
    ...
    public function testStopConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'b7e3adB0-4231-5311-Aa2F-bDCb66FdcAFE',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'4B8bcBaB-7cfB-bE67-ece9-5DF85eAaf9b3',
            'operate'=>'resume',
        );
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'C35e9ec3-F56F-c1D2-EdAF-442137cBd8F4',),
        );
