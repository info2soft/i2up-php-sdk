<?php
namespace i2up\Test\v20240819\bigdata;

use i2up\bigdata\v20240819\Backup;
...
class BackupTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListBigdataHiveTable()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'C42F4dB8-B313-16e3-1251-aBc5eF4EcdA7',
            'table_name'=>'',
            'limit'=>'',
            'page'=>'',
            'db_name'=>'',
    ...
    public function testListAllBigdataHiveDatabase()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'F2ACc3f2-A82e-2c7D-9b1A-E5B2d2AF09db',
            'cluster_config_path'=>'',
            'platform_uuid'=>'',
        );
