<?php
namespace i2up\Test\v20240819\vp;

use i2up\vp\v20240819\VirtualizationSupport;
...
class VirtualizationSupportTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testModifyVpMove()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'fACeAf0F-CABF-3E14-0ABA-EBeDeffCDB3F',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
    ...
    public function testModifyVpRep()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'D38a48E3-ddca-5c5C-371f-bE9e4b1A7cBc',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
