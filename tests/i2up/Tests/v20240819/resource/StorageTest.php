...
use i2up\resource\v20240819\Storage;
...
class StorageTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListStorageStatus()
    {
        ...
        $arr = array(
            ...
            '1'=>'D5e16A2B-E3Ee-4A8D-De76-4AFcbFc5EB5E',),
            'force_refresh'=>1,
        );
    ...
    public function testListBkFile()
    {
        $storage = $this -> storage;
        $arr = array(
            'tape_uuid'=>'E4A5b338-FDF2-86Ae-9Bba-2bf17b130ef8',
            'library_sn'=>'f447dB5d-9eA6-2bED-ACDe-2c7c5A9AF7BC',
            'slot_index'=>'1',
            'slot_barcode'=>'7900949705269056	',
            'slot_tapename'=>'热风验实议	',
            'slot_tapesequence'=>'7479389542180812	',
            'bk_index'=>'index',
            'bk_path'=>'path',
            'page'=>1,
            'limit'=>10,
