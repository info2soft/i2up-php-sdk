<?php
namespace i2up\Test\v20240819\dto;

use i2up\dto\v20240819\Dto;
...
class DtoTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListDtoRule()
    {
        ...
        $arr = array(
            ...
            'status'=>'LIST_STOP',
            'where_args'=>array(
            'rule_uuid'=>'29f039Bc-3ECF-BE4A-C0Df-a99bbfd54EE8',
            'status'=>'STOP',),
        );
    ...
    public function testListDtoRuleSourcePath()
    {
        $dto = $this -> dto;
        $arr = array(
            'host_uuid'=>'0cCDdAfB-C8e7-FB18-7bCb-5DF1c1D699dB',
            'timepoint'=>'@timestamp()',
            'host_ip'=>'',
            'prefix'=>'',
            'mapper_path'=>'',
