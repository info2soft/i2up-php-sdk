<?php
namespace i2up\Test\v20260626\backupWork;

use i2up\backupWork\v20260626\BackupWork;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class BackupWorkTest extends TestCase
 {
    private $backupWork;
    ...
    public function testDownloadMigrateWorkList()
    {
        $backupWork = $this -> backupWork;
        $arr = array(
            'work_uuids'=>array(),
        ...
        $res = $backupWork -> downloadMigrateWorkList($arr);
        $this->do_assert($res);
    }
    ...
    public function testListBackupWorkCdpResult()
    {
        $backupWork = $this -> backupWork;
        $arr = array(
            'work_uuid'=>'',
        ...
        $res = $backupWork -> listBackupWorkCdpResult($arr);
        $this->do_assert($res);
    }
    ...
    public function testListBackupVerifyWork()
    {
        $backupWork = $this -> backupWork;
        $arr = array(
            'search_name'=>'',
        ...
        $res = $backupWork -> listBackupVerifyWork($arr);
        $this->do_assert($res);
    }

    public function testDescribeBackupVerifyWork()
    {
        $backupWork = $this -> backupWork;
        $arr = array();
        $arr['uuid'] = "22D03E06-94D0-5E2C-336E-4BEEC2D28EC4";
        
        $res = $backupWork -> describeBackupVerifyWork($arr);
        $this->do_assert($res);
    }

    public function testDeleteBackupVerify()
    {
        $backupWork = $this -> backupWork;
        $arr = array(
            'force'=>1,
        ...
        $res = $backupWork -> deleteBackupVerify($arr);
        $this->do_assert($res);
    }
