...
use i2up\common\v20260626\LicQuota;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class LicQuotaTest extends TestCase
 {
    private $licQuota;
    ...
    public function testListLicQuota()
    {
        $licQuota = $this -> licQuota;
        $arr = array(
            'user_uuid'=>'F9DD0d29-Ed48-e36D-8EB2-D69cFEf98dD7',
            'search_field'=>'quota_uuid',
            'search_value'=>'E9f6fC66-11bB-5A7f-DBbE-BcbbE226d629',
            'limit'=>15,
            'page'=>1,
        );
    ...
    public function testGetLicQuotaSettings()
    {
        $licQuota = $this -> licQuota;
        $arr = array();
        
        
        $res = $licQuota -> getLicQuotaSettings($arr);
        $this->do_assert($res);
    }

    public function testUpdateLicQuotaSettings()
    {
        $licQuota = $this -> licQuota;
        $arr = array(
            'lic_quota_overflow_global_switch'=>1,
            'user_overflow_list'=>array(
            '0'=>array(
            'user_uuid'=>'',
            'percentage'=>1,),),
            'global_percentage'=>1,
        ...
        $res = $licQuota -> updateLicQuotaSettings($arr);
        $this->do_assert($res);
    }
