...
use i2up\common\v20260626\Settings;
...
class SettingsTest extends TestCase
 {
    ...
    public function testListTopologyBackupServers()
    {
        $settings = $this -> settings;
        $arr = array();
        
        
        $res = $settings -> listTopologyBackupServers($arr);
        $this->do_assert($res);
    }

    public function testSetTopologyBackupServers()
    {
        $settings = $this -> settings;
        $arr = array(
            'node_uuids'=>array(),
        ...
        $res = $settings -> setTopologyBackupServers($arr);
        $this->do_assert($res);
    }

    public function testDescribeTopologyBackupServersData()
    {
        $settings = $this -> settings;
        $arr = array();
        
        
        $res = $settings -> describeTopologyBackupServersData($arr);
        $this->do_assert($res);
    }
