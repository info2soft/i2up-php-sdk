...
use i2up\stream\v20260626\ObjCmp;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class ObjCmpTest extends TestCase
 {
    private $objCmp;
    ...
    public function testListSyncObjCmpStatus()
    {
        $objCmp = $this -> objCmp;
        $arr = array(
            'uuids'=>array(),
        ...
        $res = $objCmp -> listSyncObjCmpStatus($arr);
        $this->do_assert($res);
    }

    public function testExportSyncObjCmp()
    {
        $objCmp = $this -> objCmp;
        $arr = array(
            'include_active_db'=>1,
        ...
        $res = $objCmp -> exportSyncObjCmp($arr);
        $this->do_assert($res);
    }
