...
use i2up\recoveryRule\v20260626\RecoveryRuleV3;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class RecoveryRuleV3Test extends TestCase
 {
    ...
    public function testCreateRecovery()
    {
        ...
        $arr = array(
            ...
            'disk_name'=>'',
            'data_manager_uuid'=>'',
            'tablespace_remap'=>array(
            '0'=>array(
            'origin_name'=>'',
            'remap_name'=>'',),),
            'user_remap'=>array(),
            'tablespace_remap_select'=>1,
            'user_remap_select'=>1,
            'authentication'=>1,
        );
