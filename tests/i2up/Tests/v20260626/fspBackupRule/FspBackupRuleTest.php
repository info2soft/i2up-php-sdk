<?php
namespace i2up\Test\v20260626\fspBackupRule;

use i2up\fspBackupRule\v20260626\FspBackupRule;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class FspBackupRuleTest extends TestCase
 {
    ...
    public function testCreateFspBackupRule()
    {
        ...
        $arr = array(
            ...
            'cdp_param'=>'',
            'delay_alarm'=>'',
            'delay_alarm_threshold'=>'',
            'delay_alarm_threshold_unit'=>'',
            'delay_alarm_duration'=>'',
            'delay_alarm_duration_unit'=>'',
            'backup_method'=>1,
            'crc_check'=>1,
        );
    ...
    public function testBatchModifyFspBackupRule()
    {
        $fspBackupRule = $this -> fspBackupRule;
        $arr = array(
            'rule_uuids'=>array(),
        ...
        $res = $fspBackupRule -> batchModifyFspBackupRule($arr);
        $this->do_assert($res);
    }
