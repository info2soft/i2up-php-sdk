<?php
namespace i2up\Test\v20260626\cfs;

use i2up\cfs\v20260626\CfsBackup;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class CfsBackupTest extends TestCase
 {
    private $cfsBackup;
    ...
    public function testFailoverCfsBackup()
    {
        $cfsBackup = $this -> cfsBackup;
        $arr = array(
            'rep_uuids'=>array(),
        ...
        $res = $cfsBackup -> failoverCfsBackup($arr);
        $this->do_assert($res);
    }
    ...
    public function testDescribeCfsBackupLetency()
    {
        $cfsBackup = $this -> cfsBackup;
        $arr = array(
            'rep_uuid'=>'',
        ...
        $res = $cfsBackup -> describeCfsBackupLetency($arr);
        $this->do_assert($res);
    }

    public function testCheckCfsBackupCachedData()
    {
        $cfsBackup = $this -> cfsBackup;
        $arr = array(
            'rep_uuid'=>'',
        ...
        $res = $cfsBackup -> checkCfsBackupCachedData($arr);
        $this->do_assert($res);
    }
