<?php
namespace i2up\Test\v20260626\backupSet;

use i2up\backupSet\v20260626\BackupSet;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class BackupSetTest extends TestCase
 {
    private $backupSet;
    ...
    public function testManualForceCleanDbBackupSet()
    {
        ...
        $res = $backupSet -> manualForceCleanDbBackupSet($arr);
        $this->do_assert($res);
    }
