<?php
namespace i2up\Test\v20260626\fspRecoveryRule;

use i2up\fspRecoveryRule\v20260626\FspRecoveryRule;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class FspRecoveryRuleTest extends TestCase
 {
    ...
    public function testPowerOnFspRecoveryRule()
    {
        $fspRecoveryRule = $this -> fspRecoveryRule;
        $arr = array(
            'operate'=>'',
        ...
        $res = $fspRecoveryRule -> powerOnFspRecoveryRule($arr);
        $this->do_assert($res);
    }

    public function testPowerOffFspRecoveryRule()
    {
        $fspRecoveryRule = $this -> fspRecoveryRule;
        $arr = array(
            'operate'=>'',
        ...
        $res = $fspRecoveryRule -> powerOffFspRecoveryRule($arr);
        $this->do_assert($res);
    }

    public function testOpenConsoleFspRecoveryRule()
    {
        $fspRecoveryRule = $this -> fspRecoveryRule;
        $arr = array(
            'operate'=>'',
        ...
        $res = $fspRecoveryRule -> openConsoleFspRecoveryRule($arr);
        $this->do_assert($res);
    }
