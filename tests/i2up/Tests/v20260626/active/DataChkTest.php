...
use i2up\active\v20260626\DataChk;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class DataChkTest extends TestCase
 {
    private $dataChk;
    ...
    public function testListDatacheckObjCmpResultTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'89944FB8-A4a4-450A-98D1-eD9D5b8476a3',
        );
    ...
    public function testDescribeDatacheckObjCmpResult()
    {
        ...
        $arr = array(
            'BackLackOnly'=>0,
            'uuid'=>'8F9D8E9C-e1DF-117b-1A3E-51A2BC30F0C5',
            'start_time'=>'',
            'limit'=>1,
            'offset'=>'',
            'search_value'=>'',
    ...
    public function testDescribeDatacheckObjCmpResultTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'6eaF9b32-EBe9-6Ee8-Efd9-0fDAEF6E1bce',
            'time_list'=>array(),
        );
    ...
    public function testDescribeTbCmp()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'da66C6D2-D9df-859b-44dA-18D9DAfdb044',
        );
        $arr['uuid'] = "22D03E06-94D0-5E2C-336E-4BEEC2D28EC4";
    ...
    public function testDeleteTbCmp()
    {
        ...
        $arr = array(
            'force'=>false,
            'uuids'=>'682E7A67-d5C2-6EF7-9FC3-CbD1AfB1DEf4',
        );
    ...
    public function testStopTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'D2B809f1-FCBB-3D0d-d0D0-44190ef67008',
            'tb_cmp_name'=>'',
        );
    ...
    public function testRestartTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'b9c2D9C0-b1D6-A827-B35F-d6Ffa6A83e8e',
            'tb_cmp_name'=>'',
        );
    ...
    public function testResumeTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'3dF587B8-31DA-8aF6-Bf5e-e94efbfF8fFE',
            'tb_cmp_name'=>'',
        );
    ...
    public function testDescribeTbCmpResuluTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'time_list'=>'5c2C26De-d5bA-B798-0ac7-e5C0b779cd74',
            'uuid'=>'',
        );
    ...
    public function testDescribeTbCmpResult()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'6AEA2FAD-EC2F-B68b-556c-62235FFc13bB',
            'start_time'=>'',
            'flag'=>1,
        );
    ...
    public function testDescribeTbCmpErrorMsg()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'771eD3DC-Cd73-39B1-2f1f-8d365E46A662',
            'start_time'=>'',
            'name'=>'',
            'owner'=>'admin',
        );
    ...
    public function testDescribeTbCmpCmpDesc()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'94c2e1eb-6A55-63fb-3BBB-a8ad9fF3EEca',
            'start_time'=>'',
            'name'=>'',
            'owner'=>'admin',
        );
