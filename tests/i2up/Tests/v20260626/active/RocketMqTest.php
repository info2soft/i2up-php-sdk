...
use i2up\active\v20260626\RocketMq;
...
class RocketMqTest extends TestCase
 {
    ...
    public function testModifyRocketMqRule()
    {
        ...
        $arr = array(
            ...
            'target_user'=>'oracle',
            'target_db_name'=>'Jessica Smith',
            'db_name'=>'Donna Thomas',
    ...
    public function testDeleteRocketMqRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'6649a5Ac-B162-BDcc-69Ea-02Cd9d3eda26',
            '1'=>'f8FAcEbB-Be53-95EA-f62C-4b2F7EE5D74F',),
        );
    ...
    public function testStopRocketMqRule()
    {
        $rocketMq = $this -> rocketMq;
        $arr = array(
            'uuid'=>'3AFEA46d-e89D-e7F6-Fda4-e8a8CbF9dDcd',
            'operate'=>'resume',
        );
    ...
    public function testResumeRocketMqRule()
    {
        $rocketMq = $this -> rocketMq;
        $arr = array(
            'uuid'=>'12ECC7cE-2cB2-7a0e-c1A9-3BddbC3A58fD',
            'operate'=>'resume',
        );
    ...
    public function testListRocketMqRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'Bf3cFDEe-AEA2-05CC-CE4d-512d88AFC71E',),
        );
