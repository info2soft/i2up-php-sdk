...
use i2up\active\v20260626\HeteroConsumer;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class HeteroConsumerTest extends TestCase
 {
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'EbEB8a87-1AFD-7dAA-8bd4-D1Bc8B632A7c',),
        );
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'machine_num'=>1,
            'target_user'=>'oracle',
            'target_db_name'=>'Steven Taylor',
            'error_deal'=>'',
            'db_name'=>'Sandra Johnson',
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'8D1F1b6F-DC12-Aefe-BD53-52FbfCDd66Bd',
            '1'=>'0C5E915C-8eD8-f69A-bDa5-3D0c0A6360cf',),
        );
    ...
    public function testStopConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'EbeC5Fc3-AE83-beDa-EB6F-2b8d0531b08f',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'834c19ED-9cc0-29ec-31Ff-751796c8C0ea',
            'operate'=>'resume',
        );
    ...
    public function testExportConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'include_active_db'=>1,
        ...
        $res = $heteroConsumer -> exportConsumerRule($arr);
        $this->do_assert($res);
    }
    ...
    public function testImportHeteroConsumerTopicMapping()
    {
        ...
        $res = $heteroConsumer -> importHeteroConsumerTopicMapping($arr);
        $this->do_assert($res);
    }
