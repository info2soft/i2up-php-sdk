<?php
namespace i2up\Test\v20260626\appContinuity;

use i2up\appContinuity\v20260626\AppContinuity;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class AppContinuityTest extends TestCase
 {
    ...
    public function testStartVmAppContinuity()
    {
        $appContinuity = $this -> appContinuity;
        $arr = array(
            'rep_uuids'=>array(),
        ...
        $res = $appContinuity -> startVmAppContinuity($arr);
        $this->do_assert($res);
    }

    public function testStopVmAppContinuity()
    {
        $appContinuity = $this -> appContinuity;
        $arr = array(
            'rep_uuids'=>array(),
        ...
        $res = $appContinuity -> stopVmAppContinuity($arr);
        $this->do_assert($res);
    }

    public function testModifyVmAppContinuity()
    {
        $appContinuity = $this -> appContinuity;
        $arr = array(
            'rep_uuids'=>array(),
        ...
        $res = $appContinuity -> modifyVmAppContinuity($arr);
        $this->do_assert($res);
    }
