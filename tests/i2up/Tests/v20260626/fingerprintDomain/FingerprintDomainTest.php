<?php
namespace i2up\Test\v20260626\fingerprintDomain;

use i2up\fingerprintDomain\v20260626\FingerprintDomain;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class FingerprintDomainTest extends TestCase
 {
    ...
    public function testOperateFingerprintDomain()
    {
        $fingerprintDomain = $this -> fingerprintDomain;
        $arr = array(
            'operate'=>'',
        ...
        $res = $fingerprintDomain -> operateFingerprintDomain($arr);
        $this->do_assert($res);
    }
