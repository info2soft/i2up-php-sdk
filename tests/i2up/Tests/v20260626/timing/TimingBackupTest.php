<?php
namespace i2up\Test\v20260626\timing;

use i2up\timing\v20260626\TimingBackup;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class TimingBackupTest extends TestCase
 {
    ...
    public function testListGaussDBDatabaseTables()
    {
        $timingBackup = $this -> timingBackup;
        $arr = array(
            'node_uuid'=>'',
        ...
        $res = $timingBackup -> listGaussDBDatabaseTables($arr);
        $this->do_assert($res);
    }
    ...
    public function testDescribeGoldebDBInfo()
    {
        $timingBackup = $this -> timingBackup;
        $arr = array(
            'node_uuid'=>'',
        ...
        $res = $timingBackup -> describeGoldebDBInfo($arr);
        $this->do_assert($res);
    }

    public function testVerifyGoldebDB()
    {
        $timingBackup = $this -> timingBackup;
        $arr = array(
            'node_uuid'=>'',
        ...
        $res = $timingBackup -> verifyGoldebDB($arr);
        $this->do_assert($res);
    }
    ...
    public function testListTimingWork()
    {
        ...
        $res = $timingBackup -> listTimingWork($arr);
        $this->do_assert($res);
    }
    ...
    public function testDeleteTimingWork()
    {
        ...
        $res = $timingBackup -> deleteTimingWork($arr);
        $this->do_assert($res);
    }
