<?php
namespace i2up\Test\v20260626\bigdataRecoveryRule;

use i2up\bigdataRecoveryRule\v20260626\BigdataRecoveryRule;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class BigdataRecoveryRuleTest extends TestCase
 {
