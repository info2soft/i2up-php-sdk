<?php
namespace i2up\Test\v20260626\vpRecoveryRule;

use i2up\vpRecoveryRule\v20260626\VpRecoveryRule;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class VpRecoveryRuleTest extends TestCase
 {
    ...
    public function testCreateVpRecoveryRule()
    {
        ...
        $res = $vpRecoveryRule -> createVpRecoveryRule($arr);
        $this->do_assert($res);
    }
    ...
    public function testListDiskList()
    {
        $vpRecoveryRule = $this -> vpRecoveryRule;
        $arr = array(
            'task_uuid'=>'',
        ...
        $res = $vpRecoveryRule -> listDiskList($arr);
        $this->do_assert($res);
    }

    public function testCanMigrateCheck()
    {
        $vpRecoveryRule = $this -> vpRecoveryRule;
        $arr = array(
            'speed'=>1,
        ...
        $res = $vpRecoveryRule -> canMigrateCheck($arr);
        $this->do_assert($res);
    }
    ...
    public function testMigrate()
    {
        ...
        $res = $vpRecoveryRule -> migrate($arr);
        $this->do_assert($res);
    }
