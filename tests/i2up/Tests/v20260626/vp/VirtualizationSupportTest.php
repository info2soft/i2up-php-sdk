<?php
namespace i2up\Test\v20260626\vp;

use i2up\vp\v20260626\VirtualizationSupport;
...
class VirtualizationSupportTest extends TestCase
 {
    ...
    public function testModifyVpMove()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'1cdfF69e-417d-eC2b-eB7c-E3fb53B9FdD0',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
    ...
    public function testModifyVpRep()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'5E96BAd8-6E42-D5BF-2cAf-3CD61FfcB937',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
