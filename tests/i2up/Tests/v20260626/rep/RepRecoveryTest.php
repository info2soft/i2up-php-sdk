<?php
namespace i2up\Test\v20260626\rep;

use i2up\rep\v20260626\RepRecovery;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class RepRecoveryTest extends TestCase
 {
    private $repRecovery;
    ...
    public function testListCDPRcData()
    {
        $repRecovery = $this -> repRecovery;
        $arr = array(
            'node_uuid'=>'',
        ...
        $res = $repRecovery -> listCDPRcData($arr);
        $this->do_assert($res);
    }
