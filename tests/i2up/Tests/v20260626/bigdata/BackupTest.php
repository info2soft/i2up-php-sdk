<?php
namespace i2up\Test\v20260626\bigdata;

use i2up\bigdata\v20260626\Backup;
...
class BackupTest extends TestCase
 {
    ...
    public function testListBigdataHiveTable()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'Fc2d13EB-DeAc-1fc1-A2d1-FdDdcBA75BC2',
            'table_name'=>'',
            'limit'=>'',
            'page'=>'',
            'db_name'=>'',
    ...
    public function testListAllBigdataHiveDatabase()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'3eE6ECaC-ABb5-d7d1-1dd3-C18ED87e22A8',
            'cluster_config_path'=>'',
            'platform_uuid'=>'',
        );
