...
use i2up\resource\v20260626\Node;
...
class NodeTest extends TestCase
 {
    ...
    public function testCreateNode()
    {
        ...
        $arr = array(
            ...
            'fp_port'=>1,
            'fp_dir'=>'',
            'ndmp_server_switch'=>1,
            'agent_vm_switch'=>1,
            'ndmp_data_port_end'=>10100,
            'ndmp_data_port_begin'=>10001,
            'sfs_load'=>1,
            'organization_id'=>'',
            'resource_group_id'=>'',
            'vp_tenant_id'=>'',
    ...
    public function testDeleteNode()
    {
        ...
        $arr = array(
            'node_uuids'=>array(
            '0'=>'b27E785f-1d2D-AAC1-4aEF-5AF65cFBdded',),
            'delete_quota'=>1,
            'force'=>1,
        );
    ...
    public function testRestartNodeProcess()
    {
        ...
        $res = $node -> restartNodeProcess($arr);
        $this->do_assert($res);
    }
    ...
    public function testInsmodNodeProcess()
    {
        ...
        $res = $node -> insmodNodeProcess($arr);
        $this->do_assert($res);
    }
    ...
    public function testInstallNodeProcess()
    {
        ...
        $res = $node -> installNodeProcess($arr);
        $this->do_assert($res);
    }
