...
use i2up\resource\v20260626\Storage;
...
class StorageTest extends TestCase
 {
    ...
    public function testListStorageStatus()
    {
        ...
        $arr = array(
            ...
            '1'=>'A777ddf2-D5Bc-B581-5F0b-Ab7EB2e9aa9e',),
            'force_refresh'=>1,
        );
    ...
    public function testListBkFile()
    {
        $storage = $this -> storage;
        $arr = array(
            'tape_uuid'=>'4DE7DAe9-5216-d3a7-9Cfb-c6Defd312f2D',
            'library_sn'=>'e6C3465a-45cD-44F8-DDEC-dA1De765b4C8',
            'slot_index'=>'1',
            'slot_barcode'=>'6318462959878972	',
            'slot_tapename'=>'张员消为如	',
            'slot_tapesequence'=>'5033544568666346	',
            'bk_index'=>'index',
            'bk_path'=>'path',
            'page'=>1,
            'limit'=>10,
