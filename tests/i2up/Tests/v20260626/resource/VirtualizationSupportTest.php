...
use i2up\resource\v20260626\VirtualizationSupport;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class VirtualizationSupportTest extends TestCase
 {
    ...
    public function testListUsedIp()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
            'subnet_id'=>'',
        ...
        $res = $virtualizationSupport -> listUsedIp($arr);
        $this->do_assert($res);
    }
    ...
    public function testListOrganizations()
    {
        ...
        $res = $virtualizationSupport -> listOrganizations($arr);
        $this->do_assert($res);
    }
    ...
    public function testListResourceGroups()
    {
        ...
        $res = $virtualizationSupport -> listResourceGroups($arr);
        $this->do_assert($res);
    }

    public function testListLianTongTenants()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
            'vp_uuid'=>'',
        ...
        $res = $virtualizationSupport -> listLianTongTenants($arr);
        $this->do_assert($res);
    }

    public function testListLianTongRegions()
    {
        $virtualizationSupport = $this -> virtualizationSupport;
        $arr = array(
            'vp_uuid'=>'',
        ...
        $res = $virtualizationSupport -> listLianTongRegions($arr);
        $this->do_assert($res);
    }
