...
use i2up\resource\v20260626\ActiveNodeClusterV3;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class ActiveNodeClusterV3Test extends TestCase
 {
    ...
    public function testListActiveNodeClusterStatus()
    {
        $activeNodeClusterV3 = $this -> activeNodeClusterV3;
        $arr = array(
            'cluster_uuids'=>'CC8d7402-885B-ebDF-9B34-f9fCCAEdFC9B',
        );
    ...
    public function testListActiveNodeClusterCandidates()
    {
        $activeNodeClusterV3 = $this -> activeNodeClusterV3;
        $arr = array(
            'uuid'=>'',
        ...
        $res = $activeNodeClusterV3 -> listActiveNodeClusterCandidates($arr);
        $this->do_assert($res);
    }

    public function testMigrateActiveNodeCluster()
    {
        $activeNodeClusterV3 = $this -> activeNodeClusterV3;
        $arr = array(
            'tgt_uuid'=>'0',
        ...
        $res = $activeNodeClusterV3 -> migrateActiveNodeCluster($arr);
        $this->do_assert($res);
    }
