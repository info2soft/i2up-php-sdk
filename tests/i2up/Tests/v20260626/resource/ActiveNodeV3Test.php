...
use i2up\resource\v20260626\ActiveNodeV3;
use i2up\common\Auth;
use PHPUnit\Framework\TestCase;
                
class ActiveNodeV3Test extends TestCase
 {
    ...
    public function testListDbStatus()
    {
        $activeNodeV3 = $this -> activeNodeV3;
        $arr = array(
            'uuids'=>'75d35ed0-D256-3Ccc-19d5-D4e24cB9De97',
        );
    ...
    public function testCreateDbUnified()
    {
        ...
        $arr = array(
            'biz_grp_list'=>array(),
            'db_name'=>'Dorothy Johnson',
            'node_uuid'=>'ae435b3c-aDd7-fbdd-d6ed-D2fFE2aba1EF',
            'db_type'=>'oracle',
            'file_open_type'=>'0',
            'deploy_mode'=>'0',
            'log_read_type'=>'file',
            ...
            'server_service'=>'',
            'server_password'=>'',),),),
            'db_uuid'=>'08C7C9bf-368D-Eb0c-A1E5-efFbe0BcDFd6',
            'db_mode'=>'',
            'cdb'=>'ba3CB5ec-DCc1-ACA0-BAFC-9bb60d64Df3a',
            'maintenance'=>'',
            'password'=>'',
            'comment'=>'',
        );
    ...
    public function testModifyDb()
    {
        ...
        $arr = array(
            ...
            'ip'=>'',
            'thread'=>'',),),),
            'cdb'=>'B6D85Bc5-ceFD-eCee-AeEE-BDc2F94492c8',
            'maintenance'=>'',
            'password'=>'',
        );
    ...
    public function testActiveNode()
    {
        ...
        $arr = array(
            ...
            'cluster_switch'=>1,
            'node_uuids'=>'',
            'password'=>'D6b3ad0c-d2FC-A6C7-acB8-7B7FEB113D75',
            'node_type'=>'',
            'phy_type'=>1,
            'log_dir'=>'/var/i2data/log/',
            'registered'=>1,
            'maintenance'=>0,
            'node_name'=>'Frank Davis',
            'comment'=>'string',
            'web_uuid'=>'ABE3f1D2-868A-f8EB-7ede-7DEdd3dD02C7',
            'min_port'=>1,
            'max_port'=>1,
        );
    ...
    public function testListNodeStatus()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'fAfe1f57-6eed-d15D-7614-917FaB3b81e7',
            '1'=>'58c121Bb-9Dd5-cD38-EBc5-A560AeAcbeBD',),
        );
    ...
    public function testModifyNode()
    {
        ...
        $arr = array(
            ...
            'maintenance'=>0,
            'comment'=>'string',
            'web_uuid'=>'CBceB7bC-31d1-3Bfb-E515-11D41A27a51d',
            'node_name'=>'Steven Allen',
        );
    ...
    public function testDeleteNode()
    {
        ...
        $arr = array(
            'force'=>0,
            'uuids'=>array(
            '0'=>'4EBDbB7A-0dD9-b3DC-3F68-eC4dc6CFFCD2',
            '1'=>'758bF9cE-FedE-6fCd-954c-41d2f149f43D',),
        );
    ...
    public function testUpgradeNode()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'15ead5f1-522C-947c-F2fA-2fa384dF3CeF',),
        );
