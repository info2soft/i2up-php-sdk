...
use i2up\common\v20260209\Logs;
...
class LogsTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListResList()
    {
        $logs = $this -> logs;
        $arr = array(
            'uuid'=>'',
        ...
        $res = $logs -> listResList($arr);
        $this->do_assert($res);
    }

    public function testOnlineListFiles()
    {
        $logs = $this -> logs;
        $arr = array(
            'uuid'=>'',
        ...
        $res = $logs -> onlineListFiles($arr);
        $this->do_assert($res);
    }

    public function testOnlineGetContent()
    {
        $logs = $this -> logs;
        $arr = array(
            'page'=>1,
        ...
        $res = $logs -> onlineGetContent($arr);
        $this->do_assert($res);
    }

    public function testOnlineDownloadFile()
    {
        $logs = $this -> logs;
        $arr = array(
            'uuid'=>'',
        ...
        $res = $logs -> onlineDownloadFile($arr);
        $this->do_assert($res);
    }
