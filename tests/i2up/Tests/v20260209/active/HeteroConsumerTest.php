...
use i2up\active\v20260209\HeteroConsumer;
...
class HeteroConsumerTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'fEeB5EfA-34EB-B9C0-62BD-B14EF28dd1Ad',),
        );
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'machine_num'=>1,
            'target_user'=>'oracle',
            'target_db_name'=>'Sarah Wilson',
            'error_deal'=>'',
            'db_name'=>'Christopher Thomas',
    ...
    public function testModifyConsumerRule()
    {
        ...
        $arr = array(
            ...
            'use_source_table_key'=>false,),
            'target_user'=>'oracle',
            'target_db_name'=>'Amy Clark',
            'db_name'=>'Kimberly Thomas',
            'kerberos_certify'=>false,
            'dmltrack'=>array(
            'enable'=>false,
            'tmcol'=>'',),
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'bD9ff1ab-8239-9469-e19a-6F3CD7dE1e69',
            '1'=>'2b5f4d3B-cf56-a995-DDed-29548c33dCBf',),
        );
    ...
    public function testStopConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'cDA13A3e-E629-233c-EBce-AEBc9A5A6741',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $heteroConsumer = $this -> heteroConsumer;
        $arr = array(
            'uuid'=>'9cA1a6ce-d253-d593-abFF-7Ae2b480181c',
            'operate'=>'resume',
        );
