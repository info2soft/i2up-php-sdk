...
use i2up\active\v20260209\RocketMq;
...
class RocketMqTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testModifyRocketMqRule()
    {
        ...
        $arr = array(
            ...
            'target_user'=>'oracle',
            'target_db_name'=>'Ronald Lopez',
            'db_name'=>'Kimberly Jones',
    ...
    public function testDeleteRocketMqRules()
    {
        ...
        $arr = array(
            'force'=>true,
            'uuids'=>array(
            '0'=>'CbE3FB79-Ce4c-d39b-2CC4-1deDc3239AF2',
            '1'=>'4DE93fAB-9CcC-A3CC-6FcF-D26B1E1e9d2E',),
        );
    ...
    public function testStopRocketMqRule()
    {
        $rocketMq = $this -> rocketMq;
        $arr = array(
            'uuid'=>'495250A2-0FCf-8bB2-a1cB-E3E12402Bf5a',
            'operate'=>'resume',
        );
    ...
    public function testResumeRocketMqRule()
    {
        $rocketMq = $this -> rocketMq;
        $arr = array(
            'uuid'=>'3303189f-C18A-b1ff-EBd5-ff45ef1DBC0d',
            'operate'=>'resume',
        );
    ...
    public function testListRocketMqRules()
    {
        ...
        $arr = array(
            ...
            'username'=>'',
            'name'=>'',
            'uuid'=>'CdcC8be5-71F8-897E-EfEa-33d99f7bA8FA',),
        );
