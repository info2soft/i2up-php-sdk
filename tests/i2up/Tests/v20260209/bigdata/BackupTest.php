<?php
namespace i2up\Test\v20260209\bigdata;

use i2up\bigdata\v20260209\Backup;
...
class BackupTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListBigdataHiveTable()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'B664b4EE-bA2f-8A93-091B-fEFd2E7A8Bcb',
            'table_name'=>'',
            'limit'=>'',
            'page'=>'',
            'db_name'=>'',
    ...
    public function testListAllBigdataHiveDatabase()
    {
        $backup = $this -> backup;
        $arr = array(
            'bk_uuid'=>'EdEDe99e-dAc8-9dfE-61a6-dD4Ed1c4e78C',
            'cluster_config_path'=>'',
            'platform_uuid'=>'',
        );
