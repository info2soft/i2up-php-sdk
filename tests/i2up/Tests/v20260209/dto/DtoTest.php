<?php
namespace i2up\Test\v20260209\dto;

use i2up\dto\v20260209\Dto;
...
class DtoTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListDtoRule()
    {
        ...
        $arr = array(
            ...
            'status'=>'LIST_STOP',
            'where_args'=>array(
            'rule_uuid'=>'1D404cF6-81f8-1C84-f967-2d5D2Ca5D6B2',
            'status'=>'STOP',),
        );
    ...
    public function testListDtoRuleSourcePath()
    {
        $dto = $this -> dto;
        $arr = array(
            'host_uuid'=>'15Ac0Afb-8A78-BEd9-e4b3-C501bF5B6c2E',
            'timepoint'=>'@timestamp()',
            'host_ip'=>'',
            'prefix'=>'',
            'mapper_path'=>'',
