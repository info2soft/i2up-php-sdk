...
use i2up\stream\v20250123\TbCmp;
...
class TbCmpTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testStopTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'b1efC14A-6E88-E0cb-2F3e-b267dDf1a1f9',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testRestartTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'3eed4C71-C1C2-DEae-F40B-7653fBc0e037',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpStopTime()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'3CBd3FaA-2732-cDb7-88fB-72c8Ac3eDfcf',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpResumeTime()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'a41B8ADc-bc2d-276c-5014-BD4f4DBFC09C',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testCmpImmediate()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'c9c9C6aE-EdB1-Fcff-2B6D-9acae7EC83D5',
            'tab'=>'
[\\"asda.asdsa\\"]',
            'fix_relation'=>1,
        );
    ...
    public function testDescribeSyncTbCmpResult()
    {
        ...
        $arr = array(
            'page'=>1,
            'limit'=>10,
            'uuid'=>'5EAb65a0-FF89-49EA-07F6-7dD7EF29beC1',
            'start_time'=>'',
            'flag'=>1,
            'user'=>'',
            'table'=>'',
    ...
    public function testDescribeTbCmpErrorMsg()
    {
        ...
        $arr = array(
            'offset'=>1,
            'limit'=>10,
            'uuid'=>'E87A48Dc-9CeC-A58e-782d-b6b28ADb484d',
            'start_time'=>'',
            'key_name'=>'',
            'column_name'=>'',
            'src_db'=>'',
