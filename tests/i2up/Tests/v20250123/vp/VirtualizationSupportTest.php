<?php
namespace i2up\Test\v20250123\vp;

use i2up\vp\v20250123\VirtualizationSupport;
...
class VirtualizationSupportTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testModifyVpMove()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'fB86Eb96-376c-9e45-Fd7d-eda30D14cdaF',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
    ...
    public function testModifyVpRep()
    {
        ...
        $arr = array(
            ...
            'tgt_uuid'=>'',
            'del_bkup_swap'=>1,
            'src_uuid'=>'9bFe5AE3-c11a-BfD3-1Dbd-f3Df4dbfFF8e',
            'bk_uuid'=>'',
            'automate'=>1,
            'rule_name'=>'',
            'new_dc'=>'',
