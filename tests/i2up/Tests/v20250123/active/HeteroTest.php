...
use i2up\active\v20250123\Hetero;
...
class HeteroTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testCreateConsumerRule()
    {
        ...
        $arr = array(
            ...
            'target_user'=>'oracle',
            'target_db_name'=>'Amy Wilson',
            'db_name'=>'Barbara Young',
    ...
    public function testModifyConsumerRule()
    {
        ...
        $arr = array(
            ...
            'use_source_table_key'=>false,),
            'target_user'=>'oracle',
            'target_db_name'=>'Thomas Lee',
            'db_name'=>'Michelle Thompson',
            'kerberos_certify'=>false,
            'dmltrack'=>array(
            'enable'=>false,
            'tmcol'=>'',),
    ...
    public function testDeleteConsumerRules()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'AbEfDb7C-d91E-0DD3-49C6-91D2b8eaeC1e',
            '1'=>'C4F6c8cd-7Bc3-F8Db-5D84-C00a3855Fb46',),
            'force'=>true,
        );
    ...
    public function testStopConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'b0845512-F3a7-b5e4-Bcc5-B57dADf3d1BC',
            'operate'=>'resume',
        );
    ...
    public function testResumeConsumerRule()
    {
        $hetero = $this -> hetero;
        $arr = array(
            'uuid'=>'39Be9FBf-a9Ed-EAf9-ECc2-C5355A9be2bD',
            'operate'=>'resume',
        );
    ...
    public function testListConsumerRules()
    {
        ...
        $arr = array(
            ...
            'search_value'=>'',
            'where_args'=>array(
            'uuid'=>'EB37bB8f-DFeB-eE88-f9eD-7C54dC52F85e',
            'status'=>'',
            'src_db_name'=>'test',
            'tgt_db_name'=>'',
            'db_ip'=>'',
    ...
    public function testDeleteHeteroGraph()
    {
        ...
        $arr = array(
            'graph_uuids'=>array(
            '0'=>array(
            'graph_uuid'=>'FcB6eCE7-e7C1-7cBa-53e1-6b82871d40aA',
            'rule_uuids'=>array(
            '0'=>array(
            'uuid'=>'32Db6bc9-e69F-fdaC-af4f-0fd1389ef1Ba',
            'is_rule'=>'1',
            'rule_number'=>'4',
            'src_type'=>'oracle',),),),),
            'is_whole'=>'1',
