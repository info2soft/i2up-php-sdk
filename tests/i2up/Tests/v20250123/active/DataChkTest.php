...
use i2up\active\v20250123\DataChk;
...
class DataChkTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testCreateDatacheckObjCmp()
    {
        ...
        $arr = array(
            ...
            'config'=>array('one_task'=>'immediate',),
            'policies'=>'',
    ...
    public function testListDatacheckObjCmpResultTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'8ae2FAd0-82fB-aBbC-f1c3-E29C3bcc36Ab',
        );
    ...
    public function testDescribeDatacheckObjCmpResult()
    {
        ...
        $arr = array(
            'BackLackOnly'=>0,
            'uuid'=>'7B5bccEc-B8aE-FD6C-d666-55f751b1D8D9',
            'start_time'=>'',
            'limit'=>1,
            'offset'=>'',
            'search_value'=>'',
    ...
    public function testDescribeDatacheckObjCmpResultTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'3Fbc8BbB-b342-Edee-57EA-E1d5f8F9EcdF',
            'time_list'=>array(),
        );
    ...
    public function testDescribeTbCmp()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'uuid'=>'7c6cDb7a-642F-e5D6-5FDB-8DdFc4e85448',
        );
        $arr['uuid'] = "22D03E06-94D0-5E2C-336E-4BEEC2D28EC4";
    ...
    public function testDeleteTbCmp()
    {
        ...
        $arr = array(
            'force'=>false,
            'uuids'=>'5017051D-4329-fB5f-Fd21-D7bB2Fb9BD30',
        );
    ...
    public function testStopTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'fFbfd69F-fC52-3aBD-3cdE-fdAFc14beB50',
            'tb_cmp_name'=>'',
        );
    ...
    public function testRestartTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'51eecaCc-ADE7-F1fC-1808-2D3A59ACC595',
            'tb_cmp_name'=>'',
        );
    ...
    public function testResumeTbCmp()
    {
        ...
        $arr = array(
            'operate'=>'',
            'tb_cmp_uuids'=>'DADc515c-40b6-6CBF-D3C9-F6dbCAc0A39D',
            'tb_cmp_name'=>'',
        );
    ...
    public function testDescribeTbCmpResuluTimeList()
    {
        $dataChk = $this -> dataChk;
        $arr = array(
            'time_list'=>'F94e21E6-bA38-99F6-8382-6B0b4Bbd82Ce',
            'uuid'=>'',
        );
    ...
    public function testDescribeTbCmpResult()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'5cbbDCe4-CEf0-Fdbd-11Fc-Bd843d54Cd71',
            'start_time'=>'',
            'flag'=>1,
        );
    ...
    public function testDescribeTbCmpErrorMsg()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'Ebdc42af-0FD8-a71b-BcfC-Bf4202eB61FF',
            'start_time'=>'',
            'name'=>'',
            'owner'=>'admin',
        );
    ...
    public function testDescribeTbCmpCmpDesc()
    {
        ...
        $arr = array(
            ...
            'search_field'=>'',
            'search_value'=>'',
            'uuid'=>'0158c457-c1e6-6bdd-cd2E-Cddb2C5e1EF3',
            'start_time'=>'',
            'name'=>'',
            'owner'=>'admin',
        );
