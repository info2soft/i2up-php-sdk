...
use i2up\resource\v20250123\ActiveNode;
...
class ActiveNodeTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testActiveNode()
    {
        $activeNode = $this -> activeNode;
        $arr = array(
            'node_name'=>'George Moore',
            'address'=>'219.1.232.28',
            'data_port'=>26804,
            'cache_dir'=>'/var/i2data/cache/',
            'password'=>'6170A32F-E735-95d4-25C1-cAEcA76BCB19',
            'log_dir'=>'/var/i2data/log/',
            'registered'=>1,
            'comment'=>'string',
            'web_uuid'=>'0C6895aE-DB2f-E6E9-E64F-fcedd33c9a68',
            'port'=>array(
            'iarelay'=>'',
            'iamsk'=>'',
            'iasync'=>'',),
    ...
    public function testListNodeStatus()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'6CD98acE-eFa7-A9E4-04ED-2c1bf87EC6f7',
            '1'=>'6B3d27F6-8BA4-D5Ee-ba7D-Cea662B51b88',),
        );
    ...
    public function testModifyNode()
    {
        ...
        $arr = array(
            ...
            'registered'=>1,
            'comment'=>'string',
            'web_uuid'=>'fb7A32DC-29f2-59C3-DeFF-feF42f4A13FB',
            'port'=>array(
            'iarelay'=>'26806',
            'iamask'=>'26808',
            'iasync'=>'26803',),
    ...
    public function testDeleteNode()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'B96C3E7F-DEEF-Babe-99Ab-38D83Cd3135B',
            '1'=>'3BAdF5Df-C6Fc-2f8d-Eff0-e9F9A19A216B',),
            'force'=>0,
        );
    ...
    public function testUpgradeNode()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'62af13fD-C3b5-5a35-fF3d-FAAE553bCA9C',),
        );
    ...
    public function testRenewActiveNode()
    {
        ...
        $arr = array(
            'uuids'=>array(
            '0'=>'a8b33d7c-3F9D-1c6B-f1BD-BEb5d9D9AcAC',),
        );
    ...
    public function testListDbStatus()
    {
        $activeNode = $this -> activeNode;
        $arr = array(
            'uuids'=>'beD23c61-6B47-D01e-4Cef-6160Aae3d5bf',
        );
    ...
    public function testCreateDbUnified()
    {
        ...
        $arr = array(
            'biz_grp_list'=>array(),
            'db_name'=>'Deborah Moore',
            'node_uuid'=>'035e2A39-F1f2-d763-eF2D-494AbFc4C576',
            'db_type'=>'oracle',
            'file_open_type'=>'0',
            'deploy_mode'=>'0',
            'log_read_type'=>'file',
            ...
            'table_type'=>'',),
            'db_uuid'=>'D6AAEEfb-192c-EaFF-Dd1d-b4Cc7CCB2bfD',
            'db_mode'=>'',
            'cdb'=>'60A95c6b-4D0E-6EF5-acc3-8eb431EeA162',
            'maintenance'=>'',
            'password'=>'',
            'comment'=>'',
            'node_type'=>1,
    ...
    public function testModifyDb()
    {
        ...
        $arr = array(
            ...
            'database_name'=>'',),
            'random_str'=>'',
            'cdb'=>'BF6F0AdF-CD0b-3E5e-A33E-977Cd57De129',
            'maintenance'=>'',
        );
        $arr['uuid'] = "22D03E06-94D0-5E2C-336E-4BEEC2D28EC4";
