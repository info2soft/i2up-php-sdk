...
use i2up\common\v20250123\Statistics;
...
class StatisticsTest extends \PHPUnit_Framework_TestCase
 {
    ...
    public function testListStatisticsDisplayItems()
    {
        ...
        $res = $statistics -> listStatisticsDisplayItems($arr);
        $this->do_assert($res);
    }
    ...
    public function testSetStatisticsDisplayItems()
    {
        ...
        $res = $statistics -> setStatisticsDisplayItems($arr);
        $this->do_assert($res);
    }
