<?php
namespace i2up\backupWork\v20260209;
...
class BackupWork {
    ...
    {
        $url = $this -> url . '/backup_work/' . $body['uuid'] . '/result_list';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_work/download_failed_file_list';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_work/set_vm_priority';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
