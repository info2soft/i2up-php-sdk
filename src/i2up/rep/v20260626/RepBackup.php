...
class RepBackup {
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/cdp_zfs';
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/verify_device';
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/cdp_snap_num';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    public function describeRepBackup(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/rep/backup/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/cdp_bl_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/' . $body['uuid'] . '/cdp_bl_list';
        unset($body['uuid']);
        $res = $this -> httpRequest('delete', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/' . $body['uuid'] . '/orphan_list';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/' . $body['uuid'] . '/orphan_download';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/snapshot_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/' . $body['uuid'] . '/snapshot_list';
        unset($body['uuid']);
        $res = $this -> httpRequest('delete', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/batch';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/backup/rules_chk';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
