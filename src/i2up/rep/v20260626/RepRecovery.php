...
class RepRecovery {
    ...
    {
        $url = $this -> url . '/vers/v3/rep/recovery';
    ...
    public function describeRepRecovery(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/rep/recovery/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/rep/recovery/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/recovery/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/recovery/cdp_range';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/rep/recovery/cdp_log';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
