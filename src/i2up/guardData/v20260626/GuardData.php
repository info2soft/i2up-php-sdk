<?php
namespace i2up\guardData\v20260626;
...
class GuardData {
     ...
     * @return array
     */
    public function syncGuardDataPolicies(array $body = array())
    {
        $url = $this -> url . '/vers/v3/guard_data/sync_policies';
    ...
    {
        $url = $this -> url . '/vers/v3/guard_data/' . $body['uuid'];
        unset($body['uuid']);
