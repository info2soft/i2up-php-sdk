<?php
namespace i2up\guardData\v20240228;
...
class GuardData {
    ...
    public function nodeGuardDataEnabled(array $body = array())
    {
        ...
        $url = $this -> url . 'guard_data/node_guard_data_enabled';
    ...
    public function listNodeStatus(array $body = array())
    {
        ...
        $url = $this -> url . 'guard_data/node_status';
    ...
    public function listGuardDataLogs(array $body = array())
    {
        ...
        $url = $this -> url . 'guard_data/list_guard_data_logs';
    ...
    public function threatPerception(array $body = array())
    {
        ...
        $url = $this -> url . 'guard_data/threat_perception';
