...
class CfsBackup {
    ...
    {
        $url = $this -> url . '/cfs_backup/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/cfs_backup/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/cfs_backup/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/cfs_backup/sync_status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/cfs_backup/waiting_move_number';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/cfs_backup/list_history';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
