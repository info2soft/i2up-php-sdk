...
class FspMove {
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/nic_list';
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/dir_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/verify_volume_space';
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/verify_license';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/verify_old_rule';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/verify_os_version';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/verify_environment';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/networks';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/driver_info';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    public function describeFspMove(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/fsp/move/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/fsp/move/batch';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
