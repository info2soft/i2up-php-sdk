...
class TimingRecovery {
     ...
     * @return array
     */
    public function unmountTimingRecovery(array $body = array())
    {
        $url = $this -> url . '/timing/recovery/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function mountLogonTimingRecovery(array $body = array())
    {
        $url = $this -> url . '/timing/recovery/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function unmountLogoutTimingRecovery(array $body = array())
    {
        $url = $this -> url . '/timing/recovery/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function listTimingRecoveryDb(array $body = array())
    {
     ...
     * @return array
     */
    public function operateVolume(array $body = array())
    {
