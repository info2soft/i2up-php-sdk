...
class TimingBackup {
     ...
     * @return array
     */
    public function pauseTimingBackup(array $body = array())
    {
        $url = $this -> url . '/timing/backup/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function proceedTimingBackup(array $body = array())
    {
        $url = $this -> url . '/timing/backup/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function cloneTimingBackup(array $body = array())
    {
        $url = $this -> url . '/timing/backup/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function listGauss(array $body = array())
    {
     ...
     * @return array
     */
    public function describeGoldeb(array $body = array())
    {
     ...
     * @return array
     */
    public function verifyGoldeb(array $body = array())
    {
