...
class AppHighAvailability {
    ...
    {
        $url = $this -> url . '/vers/v3/ha/script_path';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/volume_info';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/verify_name';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    public function describeHA(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/ha/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/ha/status';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/group/stage_options';
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/group/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/group/' . $body['uuid'] . '/task';
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/ha/group/' . $body['uuid'] . '/task/status';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
