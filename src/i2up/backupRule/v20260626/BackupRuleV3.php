...
class BackupRuleV3 {
     ...
     * @return array
     */
    public function listYaShanTableSpaces(array $body = array())
    {
        $url = $this -> url . '/vers/v3/backup_rule/yashan_table_spaces';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listSqlserverAliyunDatabase(array $body = array())
    {
        $url = $this -> url . '/vers/v3/backup_rule/list_sqlserver_aliyun_database';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
