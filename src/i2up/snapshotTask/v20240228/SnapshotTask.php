<?php
namespace i2up\snapshotTask\v20240228;
...
class SnapshotTask {
     ...
     * @return array
     */
    public function startSnapshot(array $body = array())
    {
     ...
     * @return array
     */
    public function stopSnapshot(array $body = array())
    {
        $url = $this -> url . '/snapshot_task/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function startImmediatelySnapshot(array $body = array())
    {
        $url = $this -> url . '/snapshot_task/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
