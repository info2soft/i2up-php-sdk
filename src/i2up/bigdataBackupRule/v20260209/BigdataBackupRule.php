<?php
namespace i2up\bigdataBackupRule\v20260209;
...
class BigdataBackupRule {
     ...
     * @return array
     */
    public function batchModifyBigdataBackupRule(array $body = array())
    {
        $url = $this -> url . '/vers/v3/bigdata/backup_rule/batch_update';
