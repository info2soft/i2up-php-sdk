...
class OfflineRule {
     ...
     * @return array
     */
    public function listOfflineRuleGroupStatus(array $body = array())
    {
        $url = $this -> url . '/offline_rule_group/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function describeOfflineRuleGroup(array $body = array())
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
     ...
     * @return array
     */
    public function modifyOfflineRuleGroup(array $body = array())
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/offline_rule_group/' . $body['uuid'];
        unset($body['uuid']);
