...
class SyncRule {
     ...
     * @return array
     */
    public function exportSyncRuleFailTable(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/fail_table_export';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function exportSyncRuleDdlError(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/ddl_error_export';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listSyncRuleFullSyncSummary(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/full_sync_summary';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listSyncRuleIncreSyncSummary(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/incre_sync_summary';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function getStreamGlobalSettings(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/global_settings';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function addStreamGlobalSettings(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/global_settings';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function deleteStreamGlobalSettings(array $body = array())
    {
        $url = $this -> url . '/vers/v3/sync_rule/global_settings';
        $res = $this -> httpRequest('delete', $url, $body);
        return $res;
