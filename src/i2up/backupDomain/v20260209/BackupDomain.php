<?php
namespace i2up\backupDomain\v20260209;
...
class BackupDomain {
    ...
    {
        $url = $this -> url . '/backup_domain/storage_unit';
    ...
    {
        $url = $this -> url . '/backup_domain/storage_unit_status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_domain/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/backup_domain/auth';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
