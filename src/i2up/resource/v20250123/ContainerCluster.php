...
class ContainerCluster {
    ...
    {
        $url = $this -> url . '/backup_destination';
    ...
    public function descibeBackupDestination(array $body = array())
    {
        ...
        $url = $this -> url . '/backup_destination/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_destination/status';
    ...
    {
        $url = $this -> url . '/container_cluster/cls_info';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/container_cluster/sync_info';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/container_cluster/resource';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/container_cluster/namespace';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/container_cluster';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/container_cluster/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/callback_settings';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listCallbackSettings(array $body = array())
    {
        $url = $this -> url . '/callback_settings';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    ...
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/callback_settings/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/callback_settings/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/callback_settings/pod_verify';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
