...
class BigdataPlatform {
    ...
    {
        $url = $this -> url . '/bigdata/backup_host/auth';
    ...
    {
        $url = $this -> url . '/bigdata/backup_host/db_auth';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/bigdata/backup_host';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    public function describeBigdataBackupHost(array $body = array())
    {
        ...
        $url = $this -> url . '/bigdata/backup_host/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/bigdata/backup_host/status';
    ...
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/bigdata/platform/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/bigdata/platform/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
