...
class Npsvr {
    ...
    {
        $url = $this -> url . '/vers/v3/vp/npsvr/auth';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/vp/npsvr/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/vp/npsvr/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/vp/npsvr/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    public function listConfigItems(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/vp/npsvr/' . $body['uuid'] . '/list_config_items';
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/vp/npsvr/' . $body['uuid'] . '/update_config_items';
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
