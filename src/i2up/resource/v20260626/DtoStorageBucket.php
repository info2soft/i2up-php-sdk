...
class DtoStorageBucket {
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage_bucket';
     ...
     * @return array
     */
    public function modifyDtoStorageBucket(array $body = array())
    {
        $url = $this -> url . '/vers/v3/dto/storage_bucket/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage_bucket/import';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
