...
class DtoStorage {
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage';
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage/storage_type';
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage/bucket_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage/bucket';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/storage/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
