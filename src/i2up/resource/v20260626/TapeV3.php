...
class TapeV3 {
     ...
     * @return array
     */
    public function scanTapeLibraries(array $body = array())
    {
        $url = $this -> url . '/vers/v3/tape_library/scan';
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/drivers';
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/refresh_slot';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/busy_slot';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/busy_ie_slot';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/drivers_operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function resetTapeLibraryDrivers(array $body = array())
    {
        $url = $this -> url . '/vers/v3/tape_library/drivers_operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/tape_pools';
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/tape_pool';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/tape_pool/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/bkdata';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/bkfiles';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_media/details';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/refresh';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/robotic_arm_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/freeze_number';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/robotic_arm';
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function registerTapeLibraryBackupSvrDrivers(array $body = array())
    {
        $url = $this -> url . '/vers/v3/tape_library/register';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/backup_svr_drivers';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/tape_library/backup_svr';
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
