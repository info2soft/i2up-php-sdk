...
class DtoHost {
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/auth';
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/node';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/archive_date';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/rc_time_point';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/archive_file';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        if (empty($body) || !isset($body['uuid'])) return $body;
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/load_rules';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/backup_record';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/revert_file';
        unset($body['uuid']);
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/host/' . $body['uuid'] . '/revert_record';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
