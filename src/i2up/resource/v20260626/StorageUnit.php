...
class StorageUnit {
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit';
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit/rules_chk';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function nasVerify(array $body = array())
    {
        $url = $this -> url . '/vers/v3/storage_unit/nas_verify';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit_group';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit_group/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_unit/available_concurrent';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
