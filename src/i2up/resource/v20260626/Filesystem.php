...
class Filesystem {
    ...
    {
        $url = $this -> url . '/vers/v3/filesystem';
    ...
    {
        $url = $this -> url . '/vers/v3/filesystem/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/filesystem/status';
    ...
    {
        $url = $this -> url . '/vers/v3/filesystem/load_filesystem_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/filesystem/batch_import';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
