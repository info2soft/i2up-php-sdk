...
class VirtualizationSupport {
     ...
     * @return array
     */
    public function listUsedIp(array $body = array())
    {
        $url = $this -> url . '/vp/platform/' . $body['uuid'] . '/ip_used_list';
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listOrganizations(array $body = array())
    {
        $url = $this -> url . '/vers/v3/vp/platform/list_organizations';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listResourceGroups(array $body = array())
    {
        $url = $this -> url . '/vers/v3/vp/platform/list_resource_groups';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listLianTongTenants(array $body = array())
    {
        $url = $this -> url . '/vers/v3/vp/platform/list_tenants';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listLianTongRegions(array $body = array())
    {
        $url = $this -> url . '/vers/v3/vp/platform/list_regions';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
