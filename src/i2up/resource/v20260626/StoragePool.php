...
class StoragePool {
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/available_pool_member';
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/hba_info';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/fc_target';
        $res = $this -> httpRequest('delete', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/load_pools';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/batch_import';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/storage_pool/update_config';
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
