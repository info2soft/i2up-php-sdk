...
class ActiveNodeClusterV3 {
    ...
    {
        $url = $this -> url . '/vers/v3/active/node_cluster';
    ...
    public function getActiveNodeClusterInfo(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/active/node_cluster/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/nodes';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/node';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/status';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/maintenance';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function listActiveNodeClusterCandidates(array $body = array())
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/candidate';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function migrateActiveNodeCluster(array $body = array())
    {
        $url = $this -> url . '/vers/v3/active/node_cluster/migrate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
