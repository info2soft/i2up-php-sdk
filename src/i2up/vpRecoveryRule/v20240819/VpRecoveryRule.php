<?php
namespace i2up\vpRecoveryRule\v20240819;
...
class VpRecoveryRule {
    ...
    {
        $url = $this -> url . '/vp/recovery_rule/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vp/recovery_rule/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vp/recovery_rule/status';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
