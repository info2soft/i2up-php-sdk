<?php
namespace i2up\appContinuity\v20240228;
...
class AppContinuity {
     ...
     * @return array
     */
    public function snapshotImmediatelyAppContinuity(array $body = array())
    {
        $url = $this -> url . '/app_continuity/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function snapshotDeleteAppContinuity(array $body = array())
    {
        $url = $this -> url . '/app_continuity/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function modifyScriptAppContinuity(array $body = array())
    {
        $url = $this -> url . '/app_continuity/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
