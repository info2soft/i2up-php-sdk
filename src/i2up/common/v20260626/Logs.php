...
class Logs {
     ...
     * @return array
     */
    public function listResList(array $body = array())
    {
        $url = $this -> url . '/vers/v3/logs/list_res_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function onlineListFiles(array $body = array())
    {
        $url = $this -> url . '/vers/v3/logs/online_list_files';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function onlineGetContent(array $body = array())
    {
        $url = $this -> url . '/vers/v3/logs/online_content';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
     ...
     * @return array
     */
    public function onlineDownloadFile(array $body = array())
    {
        $url = $this -> url . '/vers/v3/logs/online_download_file';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
