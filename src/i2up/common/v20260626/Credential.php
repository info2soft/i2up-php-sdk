...
class Credential {
    ...
    {
        $url = $this -> url . '/vers/v3/credential';
    ...
    {
        $url = $this -> url . '/vers/v3/credential/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/credential/batch';
    ...
    {
        $url = $this -> url . '/vers/v3/credential/ukey_list';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
