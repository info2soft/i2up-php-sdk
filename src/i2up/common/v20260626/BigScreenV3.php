...
class BigScreenV3 {
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen';
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/logo';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/logo_list';
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/config';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/clear_data';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/rules';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/stat';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/big_screen/graph';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
