...
class CompareResult {
    ...
    {
        $url = $this -> url . '/vers/v3/compare_result/' . $body['uuid'] . '/list';
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/compare_result/operate';
    ...
    {
        $url = $this -> url . '/vers/v3/compare_result';
    ...
    public function viewConfig(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/compare_result/' . $body['uuid'] . '/view_config';
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/vers/v3/diff_detail';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
