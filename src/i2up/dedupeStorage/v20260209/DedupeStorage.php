<?php
namespace i2up\dedupeStorage\v20260209;
...
class DedupeStorage {
     ...
     * @return array
     */
    public function modifyDedupeStorageService(array $body = array())
    {
        $url = $this -> url . '/vers/v3/dedupe_storage/' . $body['uuid'] . '/service';
        unset($body['uuid']);
        $res = $this -> httpRequest('put', $url, $body);
        return $res;
    }
