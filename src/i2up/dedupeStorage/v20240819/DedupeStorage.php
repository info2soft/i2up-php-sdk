<?php
namespace i2up\dedupeStorage\v20240819;
...
class DedupeStorage {
    ...
    {
        $url = $this -> url . '/dedupe_storage/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/dedupe_storage/status';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/dedupe_storage/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/dedupe_storage/list_bk_used_port';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
