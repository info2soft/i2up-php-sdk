<?php
namespace i2up\backupSet\v20260209;
...
class BackupSet {
     ...
     * @return array
     */
    public function listRuleBackupSet(array $body = array())
    {
        $url = $this -> url . '/backup_set/list';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_set/force_delete';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_set/clean_up';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_set/list_src_client';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_set/validation';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/backup_set/validation_result';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
