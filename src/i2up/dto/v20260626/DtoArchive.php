...
class DtoArchive {
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive';
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/export';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/archive_year';
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/download';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/restore';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/report_rule';
    ...
    public function describeDtoArchiveReportRule(array $body = array())
    {
        ...
        $url = $this -> url . '/vers/v3/dto/archive/report_rule/' . $body['uuid'];
        unset($body['uuid']);
        $res = $this -> httpRequest('get', $url);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/report_history';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/vers/v3/dto/archive/report_statistics';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
