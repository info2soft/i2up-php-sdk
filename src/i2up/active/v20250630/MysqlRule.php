...
class MysqlRule {
    ...
    {
        $url = $this -> url . '/stream/bk_takeover/bk_network_card';
    ...
    {
        $url = $this -> url . '/stream/bk_takeover';
    ...
    public function describeBkTakeover(array $body = array())
    {
        ...
        $url = $this -> url . '/stream/bk_takeover/' . $body['uuid'];
        unset($body['uuid']);
    ...
    {
        $url = $this -> url . '/stream/bk_takeover/result';
        $res = $this -> httpRequest('get', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/stream/bk_takeover/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
    ...
    {
        $url = $this -> url . '/stream/bk_takeover/status';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
    }
