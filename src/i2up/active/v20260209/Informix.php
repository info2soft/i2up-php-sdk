...
class Informix {
     ...
     * @return array
     */
    public function stopInformixRule(array $body = array())
    {
        $url = $this -> url . '/informix/rule/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function restartInformixRule(array $body = array())
    {
        $url = $this -> url . '/informix/rule/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
     ...
     * @return array
     */
    public function stopAnalysisInformixRule(array $body = array())
    {
        $url = $this -> url . '/informix/rule/operate';
        $res = $this -> httpRequest('post', $url, $body);
        return $res;
